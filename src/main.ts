...
import { 
  ...
  Tabs, Tab, Empty, Cell, Badge, Radio, RadioGroup, Uploader, DatePicker, Popup
} from 'vant'
...
app.use(Tab).use(Tabs).use(Empty).use(Cell).use(Badge).use(Radio).use(RadioGroup).use(Uploader).use(DatePicker).use(Popup)
app.use(Lazyload)
